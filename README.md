# City Paediatric Surgery Centre Project Installation Guide

## Overview

City Paediatric Surgery Centre is a project built with Laravel and Vite, utilizing two separate Tailwind configurations for the backend and frontend. This guide provides instructions for installing and running the project.
...
1. **Clone the repository:**
    ...
    ```
    git clone https://github.com/abbasmashaddy72/citypaediatricsurgerycentre.git
    cd citypaediatricsurgerycentre
    ```
